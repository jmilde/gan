...
def train(anomaly_class = 8):
    ...
    y_dim = 1
    context_weight = 1
    trial = f"ganomaly{anomaly_class}_b{batch_size}_d{dense_dim}_btlnk{btlnk_dim}_cw{context_weight}"
    ...
    # load graph
    model = ganomaly(data, data_dim, dense_dim, btlnk_dim, context_weight)
